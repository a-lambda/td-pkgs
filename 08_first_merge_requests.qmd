...
- Ouvrez **une issue par apprenant.e** : 
  ...
  “Créer une fonction qui s’appelle `get_welcome_message_simone()`, et qui renvoie le message :
  
  "Hey ! Nous sommes le 23/01/2023, c'est un super jour pour aller observer les écurueils, non ?"
  
  est appelée de la manière suivante : `get_welcome_message_simone(date = "23/01/2023")`.
